...
function [Data, fatThrust] = thermo_modelODE(~,Param_0)
...
PosY = Param_0(3);
Vx = Param_0(4);%initial x velocity [m/s]
Vz = Param_0(5);%initial v velocity [m/s]
Vy = Param_0(6)-v_windy;
volAir = Param_0(7);%initial volume of air [m^3]
mAir = Param_0(8);%initial mass of the air in the rocket [kg]
mRocket = Param_0(9);%initial mass of the rocket [kg]

V = sqrt(Vx^2 + Vz^2 + Vy^2);%magnitude of velocity [m/s]
...
Data(6) = Accely;
Data(7) = VolAirChange;
Data(8) = MassAirChange;
Data(9) = MassRocketChange;
Data = Data';
